...
import { Github, Mail, Download } from "lucide-react" /* Linkedin */
    ...
    >
      ...
      <div className="container px-4 md:px-6">
        <div className="grid gap-8 md:gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
          <div className={`flex flex-col justify-center space-y-6 md:space-y-4 transition-all duration-1000 ${isLoaded ? 'animate-fade-in-left opacity-100 translate-x-0' : 'opacity-0 translate-x-12'
            }`}>
          ...
          <div className={`flex items-center justify-center transition-all duration-1000 delay-300 ${isLoaded ? 'animate-fade-in-right opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'
            }`}>
            <div className="relative">
